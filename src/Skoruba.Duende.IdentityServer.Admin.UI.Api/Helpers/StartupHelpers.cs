...
using PrinceHarry.Duende.IdentityServer.Admin.UI.Api.Configuration.ApplicationParts;
using PrinceHarry.Duende.IdentityServer.Admin.UI.Api.Configuration.AuditLogging;
