    ...
    public static class ClientDtoApiMock
    {
        ...
        public static Faker<ClientApiDto> ClientFaker(int id)
        {
            var clientFaker = new Faker<ClientApiDto>()
               ...
               .RuleFor(o => o.DPoPValidationMode, f => f.Random.Int())
               ...
               .RuleFor(o => o.AllowedGrantTypes, f => Enumerable.Range(1, f.Random.Int(1, 10)).Select(x => f.PickRandom(ClientConsts.GetGrantTypes(true).Select(grant => grant.Id).ToList())).ToList())
